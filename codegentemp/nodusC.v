// ======================================================================
// nodusC.v generated from TopDesign.cysch
// 10/12/2016 at 11:20
...
// DieTemp_P4_v1_0(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DieTemp, CY_INSTANCE_SHORT_NAME=DieTemp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=DieTemp, )
...
module top ;
	...
	wire [0:0] tmpOE__PIN_SENSOR_1_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_1_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_1_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_1_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_1_net;

	cy_psoc3_pins_v1_10
		#(.id("c0b62872-dd41-40d0-af36-7016705f4710"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_1
		 (.oe(tmpOE__PIN_SENSOR_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_1_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_1_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SENSOR_2_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_2_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_2_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_2_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_2_net;

	cy_psoc3_pins_v1_10
		#(.id("0da120fa-1367-4a40-9342-15ba17b786c1"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_2
		 (.oe(tmpOE__PIN_SENSOR_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_2_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_2_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_RESISTOR_net;
	wire [0:0] tmpFB_0__PIN_RESISTOR_net;
	wire [0:0] tmpIO_0__PIN_RESISTOR_net;
	wire [0:0] tmpINTERRUPT_0__PIN_RESISTOR_net;
	electrical [0:0] tmpSIOVREF__PIN_RESISTOR_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_RESISTOR
		 (.oe(tmpOE__PIN_RESISTOR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_RESISTOR_net[0:0]}),
		  .io({tmpIO_0__PIN_RESISTOR_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_RESISTOR_net),
		  .interrupt({tmpINTERRUPT_0__PIN_RESISTOR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_RESISTOR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SENSOR_3_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_3_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_3_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_3_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_3_net;

	cy_psoc3_pins_v1_10
		#(.id("67477852-9b6b-4845-af86-0350227d189a"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_3
		 (.oe(tmpOE__PIN_SENSOR_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_3_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_3_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_3_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SENSOR_4_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_4_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_4_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_4_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_4_net;

	cy_psoc3_pins_v1_10
		#(.id("685f4a77-0671-4852-b6c7-2d2f005a933e"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_4
		 (.oe(tmpOE__PIN_SENSOR_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_4_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_4_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_4_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SENSOR_5_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_5_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_5_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_5_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_5_net;

	cy_psoc3_pins_v1_10
		#(.id("27a52781-ec5c-424e-8213-c168145dd741"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_5
		 (.oe(tmpOE__PIN_SENSOR_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_5_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_5_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_5_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SENSOR_6_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_6_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_6_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_6_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_6_net;

	cy_psoc3_pins_v1_10
		#(.id("4f7cee16-8c93-4f0b-819d-bfc5748d9814"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_6
		 (.oe(tmpOE__PIN_SENSOR_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_6_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_6_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_6_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SENSOR_7_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_7_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_7_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_7_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_7_net;

	cy_psoc3_pins_v1_10
		#(.id("408d6027-2789-47b7-8969-d67e2d56fb88"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_7
		 (.oe(tmpOE__PIN_SENSOR_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_7_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_7_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_7_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SENSOR_8_net;
	wire [0:0] tmpFB_0__PIN_SENSOR_8_net;
	wire [0:0] tmpIO_0__PIN_SENSOR_8_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SENSOR_8_net;
	electrical [0:0] tmpSIOVREF__PIN_SENSOR_8_net;

	cy_psoc3_pins_v1_10
		#(.id("a97cd15d-b24e-4260-8c95-5f76cbdcf5c5"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SENSOR_8
		 (.oe(tmpOE__PIN_SENSOR_8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_SENSOR_8_net[0:0]}),
		  .io({tmpIO_0__PIN_SENSOR_8_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SENSOR_8_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SENSOR_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SENSOR_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
