...
{
    0x000Eu,    /* Handle of the ANS service */
    {
        
        /* Supported New Alert Category characteristic */
        {
            0x0010u, /* Handle of the Supported New Alert Category characteristic */ 
        ...
        {
            0x0012u, /* Handle of the New Alert characteristic */ 
        ...
        {
            0x0015u, /* Handle of the Supported Unread Alert Category characteristic */ 
        ...
        {
            0x0017u, /* Handle of the Unread Alert Status characteristic */ 
        ...
        {
            0x001Au, /* Handle of the Alert Notification Control Point characteristic */ 
