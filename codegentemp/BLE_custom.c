...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* NodusC_Service service */
    {
        0x000Eu, /* Handle of the NodusC_Service service */ 
        {

            /* NodusC_Characteristic characteristic */
            {
                0x0010u, /* Handle of the NodusC_Characteristic characteristic */ 
            ...
            /* Config_sample_frequency characteristic */
            {
                0x0013u, /* Handle of the Config_sample_frequency characteristic */ 
