...
#define CYBLE_NODUSC_SERVICE_SERVICE_INDEX   (0x00u) /* Index of NodusC_Service service in the cyBle_customs array */
#define CYBLE_NODUSC_SERVICE_NODUSC_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of NodusC_Characteristic characteristic */
#define CYBLE_NODUSC_SERVICE_NODUSC_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_NODUSC_SERVICE_CONFIG_SAMPLE_FREQUENCY_CHAR_INDEX   (0x01u) /* Index of Config_sample_frequency characteristic */
#define CYBLE_NODUSC_SERVICE_CONFIG_SAMPLE_FREQUENCY_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */


#define CYBLE_NODUSC_SERVICE_SERVICE_HANDLE   (0x000Eu) /* Handle of NodusC_Service service */
#define CYBLE_NODUSC_SERVICE_NODUSC_CHARACTERISTIC_DECL_HANDLE   (0x000Fu) /* Handle of NodusC_Characteristic characteristic declaration */
#define CYBLE_NODUSC_SERVICE_NODUSC_CHARACTERISTIC_CHAR_HANDLE   (0x0010u) /* Handle of NodusC_Characteristic characteristic */
#define CYBLE_NODUSC_SERVICE_NODUSC_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0011u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_NODUSC_SERVICE_CONFIG_SAMPLE_FREQUENCY_DECL_HANDLE   (0x0012u) /* Handle of Config_sample_frequency characteristic declaration */
#define CYBLE_NODUSC_SERVICE_CONFIG_SAMPLE_FREQUENCY_CHAR_HANDLE   (0x0013u) /* Handle of Config_sample_frequency characteristic */
#define CYBLE_NODUSC_SERVICE_CONFIG_SAMPLE_FREQUENCY_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0014u) /* Handle of Custom Descriptor descriptor */
